...
static const char col_cyan[]        = "#2A0A29"; /* border color focused windows and tags */
...
static Key keys[] = {
	...
	{ MODKEY,                 XK_KP_End,       spawn,          CMD("st -e vim") },
	{ MODKEY,                 XK_KP_Down,      spawn,          CMD("st -e surf") },
	{ MODKEY,                 XK_KP_Page_Down, spawn,          CMD("st -e newsboat") },
	{ MODKEY,                 XK_KP_Left,      spawn,          CMD("deezer") },
	{ MODKEY,                 XK_KP_Begin,     spawn,          CMD("st -e neomutt") },
	{ MODKEY,                 XK_KP_Right,     spawn,          CMD("st -e vim ~/config/dwm/config.h") },
	{ MODKEY,                 XK_KP_Home,      spawn,          CMD("st -e sh ~/config/logout.sh") },
	...
	{ MODKEY|ShiftMask,       XK_KP_Page_Up,   spawn,          CMD("st -e vim /home/lutherus/buildspr/dwm/config.h") },
